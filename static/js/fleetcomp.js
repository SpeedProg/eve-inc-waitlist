...
waitlist.fleetcomp = (function(){
	...
	function init() {
		$('#waitlists').on("click", '[data-action="approveFit"]', approveFitHandler);
		$('#waitlists').on('click', '[data-action="approveEntry"]', approveEntryHandler);
		$('#waitlists').on('click', '[data-action="sendNotification"]', sendNotificationHandler);
		$('#waitlists').on('click', '[data-action="dismissEntry"]', dismissEntryHandler);
		$('#waitlists').on('click', '[data-action="invitePlayer"]', invitePlayerHandler);
		$('#waitlists').on('click', '[data-action="removePlayer"]', removePlayerHandler);
