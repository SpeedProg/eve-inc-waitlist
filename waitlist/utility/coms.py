...
class ComConnector(ABC):
    ...
    def move_to_safety(self, names: List[str]) -> None:
        ...
        """
        raise NotImplementedError('move_to_safety not implemented')
    ...
    def update_user_rights(self, wl_account_id: int, name: str) -> str:
        ...
        """
        raise NotImplementedError('update_user_rights not implemented')

    @abstractmethod
    def data_updated(self) -> None:
        """Called when coms data was updated
        """
        raise NotImplementedError('data_updated not implemented')
    ...
    def get_connect_display_info(self) -> str:
        ...
        """
        raise NotImplementedError('get_connect_display_info not implemented')

    @abstractmethod
    def get_basic_connect_info(self) -> str:
        """Return a basic connection string
        """
        raise NotImplementedError('get_basic_connect_info not implemented')
