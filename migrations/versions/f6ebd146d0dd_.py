...
def upgrade():
    ...
    op.add_column('accounts', sa.Column('access_token', sa.String(length=128), $
    op.add_column('accounts', sa.Column('access_token_expires', sa.DateTime(), $
    op.add_column('accounts', sa.Column('refresh_token', sa.String(length=128),$
