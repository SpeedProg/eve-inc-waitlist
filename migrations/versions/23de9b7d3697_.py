...
def upgrade():
    ...
    op.create_index(op.f('ix_apicache_allianceinfo_alliance_name'), 'apicache_allianceinfo', ['alliance_name'],
                    unique=False)
    op.create_index(op.f('ix_apicache_allianceinfo_executor_corp_id'), 'apicache_allianceinfo', ['executor_corp_id'],
                    unique=False)
    ...
    op.create_index(op.f('ix_apicache_characteraffiliation_alliance_id'), 'apicache_characteraffiliation',
                    ['alliance_id'], unique=False)
    op.create_index(op.f('ix_apicache_characteraffiliation_alliance_name'), 'apicache_characteraffiliation',
                    ['alliance_name'], unique=False)
    op.create_index(op.f('ix_apicache_characteraffiliation_corporation_id'), 'apicache_characteraffiliation',
                    ['corporation_id'], unique=False)
    op.create_index(op.f('ix_apicache_characteraffiliation_corporation_name'), 'apicache_characteraffiliation',
                    ['corporation_name'], unique=False)
    op.create_index(op.f('ix_apicache_characteraffiliation_name'), 'apicache_characteraffiliation', ['name'],
                    unique=False)
    ...
    op.create_index(op.f('ix_apicache_characterinfo_corporation_id'), 'apicache_characterinfo', ['corporation_id'],
                    unique=False)
    ...
    op.create_index(op.f('ix_apicache_corporationinfo_alliance_id'), 'apicache_corporationinfo', ['alliance_id'],
                    unique=False)
    ...
    op.create_table('invmarketgroups',
                    ...
                    sa.ForeignKeyConstraint(['parent_group_id'], ['invmarketgroups.market_group_id'],
    ...
    op.create_table('accounts',
                    ...
                    sa.Column('had_welcome_mail', sa.Boolean(name='had_welcome_mail'), server_default=sa.text('false'),
                              nullable=True),
    ...
    op.create_table('event_history_entries',
                    ...
                    sa.ForeignKeyConstraint(['type_id'], ['event_history_types.type_id'],
    ...
    op.create_table('fittings',
                    ...
                    sa.ForeignKeyConstraint(['ship_type'], ['invtypes.type_id'],
                                            name=op.f('fk_fittings_ship_type_invtypes')),
    ...
    op.create_table('incursion_layout',
                    ...
                    sa.ForeignKeyConstraint(['constellation'], ['constellation.constellation_id'],
                                            name=op.f('fk_incursion_layout_constellation_constellation')),
                    sa.ForeignKeyConstraint(['dockup'], ['station.station_id'],
                                            name=op.f('fk_incursion_layout_dockup_station')),
                    sa.ForeignKeyConstraint(['headquarter'], ['solarsystem.solar_system_id'],
                                            name=op.f('fk_incursion_layout_headquarter_solarsystem')),
                    sa.ForeignKeyConstraint(['staging'], ['solarsystem.solar_system_id'],
    ...
    op.create_table('waitlist_groups',
                    ...
                    sa.ForeignKeyConstraint(['constellation_id'], ['constellation.constellation_id'],
                                            name=op.f('fk_waitlist_groups_constellation_id_constellation')),
                    sa.ForeignKeyConstraint(['dockup_id'], ['station.station_id'],
                                            name=op.f('fk_waitlist_groups_dockup_id_station')),
                    sa.ForeignKeyConstraint(['system_id'], ['solarsystem.solar_system_id'],
    ...
    op.create_table('whitelist',
                    ...
                    sa.ForeignKeyConstraint(['admin_id'], ['characters.id'],
                                            name=op.f('fk_whitelist_admin_id_characters')),
                    sa.ForeignKeyConstraint(['character_id'], ['characters.id'],
    ...
    op.create_table('account_notes',
                    ...
                    sa.ForeignKeyConstraint(['account_id'], ['accounts.id'],
                                            name=op.f('fk_account_notes_account_id_accounts')),
                    sa.ForeignKeyConstraint(['by_account_id'], ['accounts.id'],
                                            name=op.f('fk_account_notes_by_account_id_accounts')),
    ...
    op.create_table('account_roles',
                    ...
                    sa.ForeignKeyConstraint(['account_id'], ['accounts.id'],
                                            name=op.f('fk_account_roles_account_id_accounts'), onupdate='CASCADE',
                                            ondelete='CASCADE'),
                    sa.ForeignKeyConstraint(['role_id'], ['roles.id'], name=op.f('fk_account_roles_role_id_roles'),
    ...
    op.create_table('backseats',
                    ...
                    sa.Column('group_id', sa.Integer(), nullable=True),
                    sa.ForeignKeyConstraint(['account_id'], ['accounts.id'],
                                            name=op.f('fk_backseats_account_id_accounts'), ondelete='CASCADE'),
                    sa.ForeignKeyConstraint(['group_id'], ['waitlist_groups.group_id'],
    ...
    op.create_table('calendar_event',
                    ...
                    sa.ForeignKeyConstraint(['approver_id'], ['accounts.id'],
                                            name=op.f('fk_calendar_event_approver_id_accounts'), onupdate='CASCADE',
                                            ondelete='CASCADE'),
                    sa.ForeignKeyConstraint(['event_category_id'], ['calendar_category.category_id'],
                                            name=op.f('fk_calendar_event_event_category_id_calendar_category'),
                                            onupdate='CASCADE', ondelete='CASCADE'),
                    sa.ForeignKeyConstraint(['event_creator_id'], ['accounts.id'],
                                            name=op.f('fk_calendar_event_event_creator_id_accounts'),
                                            onupdate='CASCADE', ondelete='CASCADE'),
    ...
    op.create_table('ccvote',
                    ...
                    sa.ForeignKeyConstraint(['voter_id'], ['characters.id'],
    ...
    op.create_table('comp_history',
                    ...
                    sa.ForeignKeyConstraint(['source_id'], ['accounts.id'],
                                            name=op.f('fk_comp_history_source_id_accounts')),
                    sa.ForeignKeyConstraint(['target_id'], ['characters.id'],
                                            name=op.f('fk_comp_history_target_id_characters')),
    ...
    op.create_table('crest_fleets',
                    ...
                    sa.ForeignKeyConstraint(['comp_id'], ['accounts.id'],
                                            name=op.f('fk_crest_fleets_comp_id_accounts')),
                    sa.ForeignKeyConstraint(['group_id'], ['waitlist_groups.group_id'],
    ...
    op.create_table('event_history_info',
                    ...
                    sa.ForeignKeyConstraint(['history_id'], ['event_history_entries.history_id'],
    ...
    op.create_table('fcs',
                    sa.Column('account_id', sa.Integer(), nullable=True),
                    sa.Column('group_id', sa.Integer(), nullable=True),
                    sa.ForeignKeyConstraint(['account_id'], ['accounts.id'], name=op.f('fk_fcs_account_id_accounts'),
                                            ondelete='CASCADE'),
                    sa.ForeignKeyConstraint(['group_id'], ['waitlist_groups.group_id'],
    ...
    op.create_table('fit_module',
                    ...
                    sa.ForeignKeyConstraint(['module_id'], ['invtypes.type_id'],
                                            name=op.f('fk_fit_module_module_id_invtypes')),
    ...
    op.create_table('fleetmanager',
                    ...
                    sa.Column('group_id', sa.Integer(), nullable=True),
                    sa.ForeignKeyConstraint(['account_id'], ['accounts.id'],
                                            name=op.f('fk_fleetmanager_account_id_accounts'), ondelete='CASCADE'),
                    sa.ForeignKeyConstraint(['group_id'], ['waitlist_groups.group_id'],
    ...
    op.create_table('linked_chars',
                    ...
                    sa.ForeignKeyConstraint(['char_id'], ['characters.id'],
                                            name=op.f('fk_linked_chars_char_id_characters'), onupdate='CASCADE',
                                            ondelete='CASCADE'),
                    sa.ForeignKeyConstraint(['id'], ['accounts.id'], name=op.f('fk_linked_chars_id_accounts'),
                                            onupdate='CASCADE', ondelete='CASCADE')
                    )
    ...
    op.create_table('trivia',
                    ...
                    sa.ForeignKeyConstraint(['created_by_id'], ['accounts.id'],
                                            name=op.f('fk_trivia_created_by_id_accounts')),
    ...
    op.create_table('calendar_backseat',
                    ...
                    sa.ForeignKeyConstraint(['event_id'], ['calendar_event.event_id'],
                                            name=op.f('fk_calendar_backseat_event_id_calendar_event'),
                                            onupdate='CASCADE', ondelete='CASCADE')
                    )
    op.create_table('calendar_organizer',
                    ...
                    sa.Column('event_id', sa.Integer(), nullable=True),
                    sa.ForeignKeyConstraint(['account_id'], ['accounts.id'],
                                            name=op.f('fk_calendar_organizer_account_id_accounts'), onupdate='CASCADE',
                                            ondelete='CASCADE'),
                    sa.ForeignKeyConstraint(['event_id'], ['calendar_event.event_id'],
                                            name=op.f('fk_calendar_organizer_event_id_calendar_event'),
                                            onupdate='CASCADE', ondelete='CASCADE')
                    )
    op.create_table('comp_history_ext_inv',
                    ...
                    sa.ForeignKeyConstraint(['history_id'], ['comp_history.history_id'],
                                            name=op.f('fk_comp_history_ext_inv_history_id_comp_history')),
                    sa.ForeignKeyConstraint(['waitlist_id'], ['waitlists.id'],
    ...
    op.create_table('comp_history_fits',
                    ...
                    sa.ForeignKeyConstraint(['fit_id'], ['fittings.id'],
                                            name=op.f('fk_comp_history_fits_fit_id_fittings')),
                    sa.ForeignKeyConstraint(['history_id'], ['comp_history.history_id'],
    ...
    op.create_table('role_changes',
                    ...
                    sa.ForeignKeyConstraint(['entry_id'], ['account_notes.entry_id'],
                                            name=op.f('fk_role_changes_entry_id_account_notes'), onupdate='CASCADE',
                                            ondelete='CASCADE'),
                    sa.ForeignKeyConstraint(['role_id'], ['roles.id'], name=op.f('fk_role_changes_role_id_roles'),
                                            onupdate='CASCADE', ondelete='CASCADE'),
    ...
    op.create_table('trivia_question',
                    ...
                    sa.Column('answer_connection', sa.Enum('AND', 'OR', 'NOT', 'NONE', name='answer_connection'),
                              nullable=True),
                    sa.Column('input_placeholder', sa.String(length=255), nullable=True),
                    sa.ForeignKeyConstraint(['trivia_id'], ['trivia.trivia_id'],
    ...
    op.create_table('trivia_submission',
                    ...
                    sa.ForeignKeyConstraint(['submittor_account_id'], ['accounts.id'],
                                            name=op.f('fk_trivia_submission_submittor_account_id_accounts')),
                    sa.ForeignKeyConstraint(['submittor_id'], ['characters.id'],
    ...
    op.create_table('waitlist_entries',
                    ...
                    sa.ForeignKeyConstraint(['user'], ['characters.id'],
                                            name=op.f('fk_waitlist_entries_user_characters')),
                    sa.ForeignKeyConstraint(['waitlist_id'], ['waitlists.id'],
    ...
    op.create_table('trivia_answer',
                    ...
                    sa.ForeignKeyConstraint(['question_id'], ['trivia_question.question_id'],
    ...
    op.create_table('trivia_submission_answer',
                    ...
                    sa.ForeignKeyConstraint(['submission_id'], ['trivia_submission.submission_id'],
    ...
    op.create_table('waitlist_entry_fits',
                    ...
                    sa.Column('fit_id', sa.Integer(), nullable=False),
                    sa.ForeignKeyConstraint(['entry_id'], ['waitlist_entries.id'],
                                            name=op.f('fk_waitlist_entry_fits_entry_id_waitlist_entries'),
                                            onupdate='CASCADE', ondelete='CASCADE'),
                    sa.ForeignKeyConstraint(['fit_id'], ['fittings.id'],
                                            name=op.f('fk_waitlist_entry_fits_fit_id_fittings'), onupdate='CASCADE',
                                            ondelete='CASCADE'),
