...
* 0.12.2
    ...
    0.11.0
        Changes
            ...
            Added "New" Tag to people that are added a T or R Badge or are a new account
                the tag is removed if the Send Auth Mail Button is pressed on their account (they get a generated mail send using the templates)
            ...
            Added a window to see in fleet information (ships in squads and how long some one is in fleet)
                this is only accessible as developer role at the moment since it is mainly an experiment to see how it could be used for a future feature
        Fixes
    ...
    0.9.2
        ...
        Fix
            Changed to JS to not use deprecated and in ES5+ removed

            with(variable){}

            statements so the transformation/bable works with out default settings on it
    0.9.1
        Features
        ...
        Changes
            ...
            Frontend
                ...
                You now need to login using the normal Login on the base site /
                    ...
                    you need to use your Main Character (the one you WTM-WL acc is named after) for logging in
        ...
        Features
            ...
            Frontend
                ...
                Fleetsettings now contain a "Safety" button
                    ...
                    Moves all members of the fleet you click on to the set Safety channel (A TeamSpeak Setting)
        ...
        Features
            ...
            Frontend
                ...
                Eve SSO login for linemembers
                    ...
                    nope Command Core still needs to use stupid links but soonTM I hope, it is just that that is a little bit more complicated because transfering characters but there is a solution to that just workingonitTM
                ...
                Added Search for Fleetcomp history where it can be filtered by Accountname, Charactername(for the target of an action) types of actions and time frame.
                    ...
                    multiple account/character names can we inputed like this "|" is the seperator, multiple names are allways an OR since 1 action can not be done by multiple people anyway

                    Bruce Warhead|Beryl Slanjava
    ...
    0.3.1
        ...
        Features
            ...
            Propagate "default" waitlist constellation/dock/system changes to all waitlists

                apparently people where moving to wrong systems because people started a assault/vg fleet and those weren't up-to-date
        ...
        Fixes
            ...
            Backend
                ...
                Fixed some exceptions related to fleetsetup and made them display useful messages

                    These only happened if you did weird things, like not fill out fields, use the back button on your browser or did not select a waitlistgroup since you didn't open any first
